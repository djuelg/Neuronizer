...
public class RenameNoteInteractorImpl extends AbstractInteractor implements RenameNoteInteractor {
    ...
    public RenameNoteInteractorImpl(Executor threadExecutor, MainThread mainThread, Callback callback, PreviewRepository repository, String uuid, String title, int position) {
